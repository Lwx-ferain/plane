...
public:
    ...
    AP_Int32 Airline_Feedforwad_distance; 
    AP_Int32 Throwwater_PWM_Pickle; 
    AP_Int8 Throwwater_Radius_Pickle;
    //AP_Int32 Throwwater_PWM_Manual_Activate;
    //AP_Int32 Throwwater_PWM_CCRP_Activate;  
    //AP_Int8 Throwwater_Altitude_Preset;
    //AP_Int8 Throwwater_Altitude_Preset_Activate;
    AP_Int8 Throwwater_SE_Reversed;
    AP_Int8 Throwwater_Yan_Pickle;
    AP_Int8 Throwwater_record_position; //记录飞机位置为靶标位置
    AP_Int8 Throwwater_Reset_rightnow; //复位投放开关
    AP_Int8 record_waypoint; // 记录航点开关
    AP_Int8 manual_control; // 手动控制投放开关
    AP_Int8 Throwwater_channel;
    AP_Int32 Throwater_throw_pwm;
    AP_Int32 Throwater_normal_pwm;
    AP_Int32 Throwwater_mix;
    //空气刹车部分变量
    AP_Int32 Airbrake_left_pwm;     // 左侧空刹舵机PWM
    AP_Int32 Airbrake_right_pwm;    // 右侧空刹舵机PWM
    AP_Int32 Airbrake_rc_channel;   // 空刹舵机通道
    AP_Int32 Airbrake_pre_left;     //左/右预设中立位至PWm
    AP_Int32 Airbrake_pre_right; 
    AP_Int8 Airbrake_enable;
    AP_Int32 Airbrake_record;
    AP_Int32 Airbrake_pre_rightmin;
    AP_Int8  Airbrake_situation;
    AP_Int16 min_pwm_left;
    AP_Int16 max_pwm_left;
    AP_Int16 min_pwm_right;
    AP_Int16 max_pwm_right;
    AP_Int16 Throwwater_extra_altitude;

    AP_Int32 man_neutral;
    AP_Int32 auto_neutral;
